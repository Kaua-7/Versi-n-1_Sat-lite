...
## Funciones disponibles en la versión 3:
...
**5.** Una simulación del período orbital del satélite 

**6.** Se incluye también un fichero que registra todos los datos, errores, cambios realizados y observaciones del usuario. Junto con la fecha y hora que estos se realizan. 

(he de seguir) +foto interfaz con nums
